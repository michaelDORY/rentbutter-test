...
const typographyVariants = cva('', {
  variants: {
    variant: {
      ...
      h3: 'text-base font-semibold text-black tracking-[0.005em]',
      h4: 'text-[12px] font-semibold text-black tracking-[0.005em] leading-[1.36em]',
      body: 'text-[14px] font-[430] tracking-[0.005em] leading-[1.42em]',
      small: 'text-[12px] text-grey-600 tracking-[0.005em] leading-[1.36em]',
    },
    align: {
      left: 'text-left',
      center: 'text-center',
